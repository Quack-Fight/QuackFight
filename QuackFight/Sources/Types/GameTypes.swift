...
///
/// | Event | Publisher System/Class | Subscriber(s) |
/// |---|---|---|
/// | `damageApplied(amount:to:)` | `DamageSystem` | `HUDNode` (flash red, update HP), `GameScene` (floating text) |
...
/// | `turnEnded` | `DamageSystem` / `HealSystem` / `FixedHitSystem` | `GameStateMachine` (to trigger handoff/round over) |
